 ...
 * SDKs) never leaks. Only the error's message and stack are logged (never the error object, which can carry a
 * request body) and nothing beyond the resolved message is returned to the client.
