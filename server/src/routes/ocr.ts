...
// Output shape is enforced by OCR_JSON_SCHEMA (structured outputs), so this prompt carries only the
// semantic rules a JSON schema can't express.
const OCR_PROMPT = `Extract the receipt data from the image.
